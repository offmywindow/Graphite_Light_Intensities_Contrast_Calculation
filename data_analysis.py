...
class arwfile:
    ...
    def __init__(self, file_path):
        ...
        with r.imread(self.file_path) as raw:
            ...
            self.R = self.corrected_data[0::2, 0::2]
            self.G1 = self.corrected_data[0::2, 1::2]
            self.G2 = self.corrected_data[1::2, 0::2]
            self.B = self.corrected_data[1::2, 1::2]
            self.rgb_image = raw.postprocess()

    # Function to analysis data from rois,collect mean values from each channel
    def mean_analysis(self, rois):
